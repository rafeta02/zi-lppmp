    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.industries.update", [$industry->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{{ old('description', $industry->description) }}</textarea>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('featured') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="featured" id="featured" value="1" {{ $industry->featured || old('featured', 0) === 1 ? 'checked' : '' }}>
