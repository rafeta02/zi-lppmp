    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.prestasi-mahasiswas.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\PrestasiMahasiswa::SKIM_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('skim') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="skim_{{ $key }}" name="skim" value="{{ $key }}" {{ old('skim', '') === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\PrestasiMahasiswa::TINGKAT_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('tingkat') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="tingkat_{{ $key }}" name="tingkat" value="{{ $key }}" {{ old('tingkat', '') === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('tanggal_awal') ? 'is-invalid' : '' }}" type="text" name="tanggal_awal" id="tanggal_awal" value="{{ old('tanggal_awal') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('tanggal_akhir') ? 'is-invalid' : '' }}" type="text" name="tanggal_akhir" id="tanggal_akhir" value="{{ old('tanggal_akhir') }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\PrestasiMahasiswa::JUMLAH_PESERTA_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('jumlah_peserta') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="jumlah_peserta_{{ $key }}" name="jumlah_peserta" value="{{ $key }}" {{ old('jumlah_peserta', '') === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_penyelenggara') ? 'is-invalid' : '' }}" type="text" name="nama_penyelenggara" id="nama_penyelenggara" value="{{ old('nama_penyelenggara', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tempat_penyelenggara') ? 'is-invalid' : '' }}" type="text" name="tempat_penyelenggara" id="tempat_penyelenggara" value="{{ old('tempat_penyelenggara', '') }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\PrestasiMahasiswa::KEIKUTSERTAAN_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('keikutsertaan') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="keikutsertaan_{{ $key }}" name="keikutsertaan" value="{{ $key }}" {{ old('keikutsertaan', '') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('url_publikasi') ? 'is-invalid' : '' }}" type="text" name="url_publikasi" id="url_publikasi" value="{{ old('url_publikasi', '') }}">
